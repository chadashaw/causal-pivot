...
```{r plot_collider_scatter, warning=F, message=F}
...
```{r control_collider_scatter, warning=F, message=F}
# massage cohort.dfs into a single dataframe containing correctly paired RV/PRS ####
...
```{r tertiles_plot_calc, warning=F, message=F}
...
tertiles.3x3 <- (
  ...
  labs(
   ...
   save.plot('fig3A', w = 3.75, h = 2.5, root.dir = PLOTS_DIR, sub.dir = 'misc')
...
```{r control_tertiles_plot_calc, warning=F, message=F}
# massage data w/ prs tertiles ####
...
```{r tertiles_plot_calc_age, warning=F, message=F}
# massage data w/ prs tertiles ####
...
```{r collider_summary_plot, warning=F, message=F}
